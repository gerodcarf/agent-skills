---
name: committee
description: "Launch a multi-model reasoning committee on a question. Fan out to 5 workers (GLM-5.2, MiniMax-M3, DeepSeek-V4-Pro, Gemini-3.5-flash, GPT-5.5) at medium reasoning, gate through a reviewer, and auto-deliver the synthesis back to this thread."
version: 1.0.0
...
Launch a Kanban Committee that fans a question out to 5 specialized worker profiles in parallel, gates the outputs through a verifier, synthesizes a final report, and auto-delivers it back to the originating thread.
